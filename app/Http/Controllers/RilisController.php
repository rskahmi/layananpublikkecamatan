...
use App\Http\Resources\PemberitaanResource;
    ...
    public function dashboardMedia()
    {
        try {
            ...
            $media = Cache::remember('media_data_in_dashboard', $this->time, function () use ($year) {
                ...
                $jumlahBerita = PemberitaanModel::whereYear('created_at', $year)->count('id');
    ...
    public function berita()
    {
        try {
            ...
            return view('before-login.berita')
                ->with(['berita' => PemberitaanResource::collection($berita)]);
        } catch (Exception $e) {
