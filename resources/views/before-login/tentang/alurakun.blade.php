...
@section('tentang-content')
    <div class="sejarah">
        <h3 class="tentang-title">Alur Registrasi Akun dan Login</h3>
        <img class="w-100" src="{{ isFileExists('storage/images/profil-perusahaan/sejarah/' . $alurakun->gambar, asset('assets/img/dafault/default-bg.png')) }}"
            alt="Gambar alurakun">
        <div class="deskripsi mt-2">
            <div class="limited-text-deskripsi">
                {!! limitCharacters($alurakun->deskripsi, 350) !!}
                @if (isLimit($alurakun->deskripsi, 350))
