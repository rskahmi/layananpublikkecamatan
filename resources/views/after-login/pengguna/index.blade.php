...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xxl-2 mb-2 mb-lg-0">
            <x-card.summary header="Total Akun" value="{{ formatRibuan($total_akun) }}" footer="dari Seluruh Pengguna" id="allUsers">
                <x-svg.icon.users />
            </x-card.summary>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xxl-2 mb-2 mb-lg-0">
            <x-card.summary header="Akun User" color="red" value="{{ formatRibuan($total_admin) }}" footer="dari Seluruh Pengguna" id="akunManager">
                <x-svg.icon.manager />
            </x-card.summary>
        </div>
        {{-- <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xxl-2 mb-2 mb-lg-0">
            <x-card.summary header="Akun Admin" color="blue" value="{{ formatRibuan($total_admin) }}"
                footer="dari Seluruh Pengguna" id="akunAdmin">
                <x-svg.icon.admin />
            </x-card.summary>
        </div> --}}
    </div>
