...
@section('title', 'Monitoring Rilis')
...
@section('content')
                    ...
                    @slot('slotBody')
                        ...
                        @foreach ($rilis as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <img width="50" height="100%" src="{{ $gambar }}" alt="Gambar {{ $item->judul }}">
                                    </ul>
                                </td>
                                @if (isAllAdmin())
                                    <td>
                                    ...
                                    '{{ $item->jenis }}')"
                                            ...
                                            <a href="{{ route('media.detail', ['id' => $item->id]) }}">
                                                <x-svg.icon.info />
                                            </a>
    ...
    @if (isAllAdmin())
        <!-- Modal -->
        <x-modals.admin id="tambahMediaModal" action="{{ route('media.store') }}">
            @slot('slotHeader')
            ...
            @slot('slotBody')
                ...
                <div class="mb-3">
                    <x-forms.textarea name="deskripsi" label="Deskripsi" placeholder="Masukkan deskripsi rilis" />
                </div>
