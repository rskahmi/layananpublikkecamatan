            ...
            var singlePointData = {
                ...
                "properties": {
                    ...
                    "jumlah": {
                        ...
                        "tjsl_percent": data.tjsl_count === 0 ? 0 : (data.tjsl_count / (data.tjsl_count + data
                            .program_count) * 100)
                    }
                },
                "tjsl": []
        ...
        pointData.forEach(function(data, index) {
            ...
            pointData[index].tjsl.forEach(function(tjslItem, tjslIndex) {
                tableContent += '<tr>' +
                    ...
                    wilayah.alamat + ', ' + wilayah.kelurahan + ', ' + wilayah
                    .kecamatan +
            ...
            marker.bindPopup(
                ...
                '<span class="subtitle">' + wilayah.kelurahan + ', ' + wilayah
                .kecamatan + '</span>' +
                tableContent +
                '</div>' +
