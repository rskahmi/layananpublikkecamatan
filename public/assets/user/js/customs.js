...
function modalEditSurat(
    ...
    nimb_bbm = null,
    kk_ktp = null,
    suratkelurahan_ktp = null,
    ktp_kk = null,
    suratkelurahan_kk = null,
    ktm_sktm =  null,
    suratkelurahan_sktm = null,
) {
    assignData("edtktp_bbm", ktp_bbm || "");
    assignData("edtnimb_bbm", nimb_bbm || "");
    assignData("edtkk_ktp", kk_ktp || "");
    assignData("edtsuratkelurahan_ktp", suratkelurahan_ktp || "");
    assignData("edtktp_kk", ktp_kk || "");
    assignData("edtsuratkelurahan_kk", suratkelurahan_kk || "");
    assignData("edtktm_sktm", ktm_sktm || "");
    assignData("edtsuratkelurahan_sktm", suratkelurahan_sktm || "");

    setForm("#form-editModal", action);
    $("#edtJenis").val(jenissurat).trigger('change');
    if (jenissurat.toLowerCase() === "bbm"){
        $("#edt-bbm-only").removeClass("d-none");
        $("#edt-ktp-only").addClass("d-none");
    }
    else if (jenissurat.toLowerCase() === "ktp"){
        $("#edt-ktp-only").removeClass("d-none");
        $("#edt-bbm-only").addClass("d-none");
    }
    else if (jenissurat.toLowerCase() === "kk"){
        $("#edt-kk-only").removeClass("d-none");
    }
    else if (jenissurat.toLowerCase() === "sktm"){
        $("#edt-sktm-only").removeClass("d-none");
    }
    else {
        $("#edt-ktp-only").addClass("d-none");
        $("#edt-bbm-only").addClass("d-none");
...
function modalEditPengaduan(action, deskripsi, bukti){
    assignData("edtdeskripsi", deskripsi);
    setForm("#form-editModal", action);

    $("#buktiLama").attr("src",bukti);
...
function pie(id, labels, data) {
    ...
    var data = {
        ...
        datasets: [
            {
                data: data,
                backgroundColor: ["#145EA8", "#65AE38","#D12031", "#EAC500"],
                offset: 5,
            },
        ],
    };
...
function modalEditProgramUnggulan(
    ...
    assignData("edtNamaProgram", nama_kegiatan);
    assignData("edtMitraBinaan", mitra);
